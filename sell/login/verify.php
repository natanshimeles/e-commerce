...
if(isset($_POST["login"])){
  ...
  if(empty($username) || empty($password)){
    ...
    //}
    $sql = "select password,Email from sellers_user_password where username=?";
    ...
    if($res = $stmt->get_result()){
      ...
      if(password_verify($password,$fetchedpassword) ){
        ...
        $Connection->close();
         ...
         header('Location:../sellersmain/manager.php');
       ...
       echo "hello";
      //header('Location:index.php?login=userdoesntexist');
